  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* MyVyrona Tab - Redirect to dedicated page */}
        {activeTab === "profile" && (
          <div className="text-center py-12">
            <div className="max-w-md mx-auto">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">MyVyrona Dashboard</h2>
              <p className="text-gray-600 mb-6">Access your profile, wallet, and account settings</p>
              <Button 
                onClick={() => setLocation('/myvyrona')}
                className="bg-blue-600 hover:bg-blue-700"
              >
                Go to MyVyrona Dashboard
              </Button>
            </div>
          </div>
        )}
